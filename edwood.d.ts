declare module 'edwood' {
    ...
    export var Cell: React.ClassicComponentClass<CellProps, {}>;
    export var cell: React.ClassicFactory<CellProps>;

    export interface UniversalProps { element: dom.Element }
    export var Universal: React.ClassicComponentClass<UniversalProps, {}>;
    export var universal: React.ClassicFactory<UniversalProps>;
}
